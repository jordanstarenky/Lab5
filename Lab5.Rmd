...
#The hypothesis is not supported because there was no significant difference between the GPA of Greek women and non-Greek women
```{r}
#Here we have 4 groups. 
...
#The hypothesis is not supported because there was no main effect of gender, aka there was no difference, on average, between men and women. There was also no simple effects showing differences between Greek women and Greek men, or non-Greek women and non-Greek men.
```{r}
#Here we have 4 groups. 
